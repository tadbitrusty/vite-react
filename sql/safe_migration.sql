-- Resume Storage and Intelligence Pipeline Migration - SAFE VERSION
-- Run this in Supabase SQL Editor (skips admin policy to avoid column errors)
...
-- Skip admin policy for now to avoid column errors
-- We'll add it later once we know the correct column name